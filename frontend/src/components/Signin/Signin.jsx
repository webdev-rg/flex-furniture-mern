      ...
      <div className="w-full h-full flex justify-center">
        <div className="sm:w-[45rem] w-full sm:p-5">
          ...
          <div className="w-full flex flex-col gap-5">
            ...
            <div className="w-full h-24 flex items-center justify-center gap-3 px-10 text-center bg-slate-100 rounded-2xl">
              <img src="/images/facebook.png" className="w-10" alt="facebook-logo" />
              <h1 className="text-3xl text-flex-furniture-950 font-semibold">Signin with Facebook</h1>
            </div>
          </div>
          <p className="mt-10 text-center text-2xl text-flex-furniture-950 font-semibold">OR</p>
